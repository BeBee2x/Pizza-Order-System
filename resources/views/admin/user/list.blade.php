                        ...
                        <tbody>
                            @foreach ($user as $item )
                                <tr class="tr-shadow">
                                    ...
                                    <td>{{ $item->address }}</td>
                                    <td class="col-3">
                                        <a href="{{ route('admin-editUserPage',$item->id) }}" class="me-1">
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Change Role">
                                                <i class="fa-solid fa-pen-to-square fs-5"></i>
                                            </button>
                                        </a>
                                        <a href="{{ route('admin-changeAdminPage',$item->id) }}" class="me-1">
                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Change Role">
                                                <i class="fa-solid fa-arrows-rotate fs-5"></i>
                                            </button>
                                        </a>
                                        <a href="{{ route('admin-deleteUser',$item->id) }}" class="me-1">
