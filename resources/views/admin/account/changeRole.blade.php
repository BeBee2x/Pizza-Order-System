                        ...
                        <form action="{{ route('admin-changeRole',$data->id) }}" method="post">
                            ...
                            <div class="row pb-2">
                                ...
                                <div class="col-6 offset-1">
                                    <h4>Do you really want to change {{ $data->name }}'s role to user?</h4>
                                    <div class="mt-3 pt-3 d-flex">
                                        ...
                                        <div class="bg-warning text-light p-3 rounded-5 shadow"><i class="fa-solid fa-user"></i> User</div>
                                    </div>
                                    <div class="mt-3" style="margin-left: -24px"><button type="submit" class="p-3 shadow-sm w-100 btn btn-info rounded-pill">Change role to user</button></div>
                                </div>
                            </div>
                            </div>
                        </form>
